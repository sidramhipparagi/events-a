  ...
  return (
    <section className="relative py-24 md:min-h-screen md:flex md:items-center md:justify-center overflow-hidden pt-28 md:pt-20">
      ...
      <div className="container mx-auto px-6 md:px-16 lg:px-24 relative z-10 text-center">
        ...
        >
          <span className="inline-block py-1 px-3 rounded-full bg-white/5 border border-white/10 text-xs font-medium tracking-widest uppercase text-primary mb-4 md:mb-6">
            Premium Event Management
          </span>
          <h1 className="text-3xl md:text-7xl lg:text-8xl font-display font-bold tracking-tight text-white mb-4 md:mb-6 leading-tight">
            Crafting Moments <br />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/contact">
              <Button size="lg" className="rounded-full px-8 text-base bg-white text-black hover:bg-white/90 h-12 w-full sm:w-auto">
                Start Planning
              </Button>
            </Link>
            <Link href="/portfolio">
              <Button variant="outline" size="lg" className="rounded-full px-8 text-base border-white/20 text-white hover:bg-white/10 h-12 group w-full sm:w-auto">
      ...
      <motion.div 
        className="hidden md:flex absolute bottom-10 left-1/2 -translate-x-1/2 text-white/30"
        animate={{ y: [0, 10, 0] }}
